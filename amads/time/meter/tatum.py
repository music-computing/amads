...
from amads.time.meter.grid import get_tatum_from_floats_and_priorities
...
def starts_to_indices(list_of_starts: list):
    ...
    >>> get_tatum_from_floats_and_priorities(combine_half_and_third)
    Fraction(1, 6)
    ...
    >>> get_tatum_from_floats_and_priorities(badly_rounded, distance_threshold=0.1)
    Fraction(1, 6)
    ...
    """
    tatum = get_tatum_from_floats_and_priorities(list_of_starts)
