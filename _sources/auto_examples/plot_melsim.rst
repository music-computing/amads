...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    * checking for file ‘/tmp/RtmpF0hCBk/remotes1e286dba3e71/pmcharrison-abcR-ddb23ba/DESCRIPTION’ ... OK
    * preparing ‘abcR’:
    ...
    * building ‘abcR_0.0.0.9007.tar.gz’
    ...
    Do you prefer later versions from sources? (Yes/no/cancel) R[read into console]: EOF when reading a line

    R[write to console]: Installing package into ‘/usr/local/lib/R/site-library’
    (as ‘lib’ is unspecified)

    R[write to console]: trying URL 'https://cloud.r-project.org/src/contrib/Rdpack_2.6.4.tar.gz'

    R[write to console]: Content type 'application/x-gzip'
    R[write to console]:  length 379140 bytes (370 KB)
    ...
    R[write to console]: downloaded 370 KB
    ...
    R[write to console]: The downloaded source packages are in
            ‘/tmp/RtmpF0hCBk/downloaded_packages’
    R[write to console]: 
    R[write to console]: 
    ...
    * checking for file ‘/tmp/RtmpF0hCBk/remotes1e2846c98c2c/pmcharrison-hrep-461f98d/DESCRIPTION’ ... OK
    * preparing ‘hrep’:
    * checking DESCRIPTION meta-information ... OK
    ...
    * building ‘hrep_0.16.1.tar.gz’
    ...
    R[write to console]: Installing 66 packages: withr, stringi, generics, cpp11, tidyselect, stringr, purrr, dplyr, timechange, Rcpp, later, fastmap, digest, base64enc, htmltools, lazyeval, jsonlite, promises, rappdirs, fs, sass, mime, memoise, cachem, tinytex, jquerylib, fontawesome, bslib, xfun, highr, evaluate, yaml, rmarkdown, knitr, lattice, colorspace, viridisLite, RColorBrewer, munsell, labeling, farver, Matrix, nlme, MASS, tidyr, snakecase, lubridate, hms, crosstalk, httpuv, htmlwidgets, GPArotation, mnormt, scales, mgcv, isoband, gtable, signal, logging, assertthat, janitor, DT, psych, ggplot2, tuneR, XML
    ...
    R[write to console]: trying URL 'https://cloud.r-project.org/src/contrib/later_1.4.2.tar.gz'

    R[write to console]: Content type 'application/x-gzip'
    R[write to console]:  length 69759 bytes (68 KB)
    ...
    R[write to console]: downloaded 68 KB


    R[write to console]: trying URL 'https://cloud.r-project.org/src/contrib/ggplot2_3.5.2.tar.gz'

    R[write to console]: Content type 'application/x-gzip'
    R[write to console]:  length 3580451 bytes (3.4 MB)
    ...
    * checking for file ‘/tmp/RtmpF0hCBk/remotes1e2825407f0c/sebsilas-itembankr-1c9c319/DESCRIPTION’ ... OK
    * preparing ‘itembankr’:
    * checking DESCRIPTION meta-information ... OK
    * checking for LF line-endings in source and make files and shell scripts
    * checking for empty or unneeded directories
    * building ‘itembankr_0.5.3.tar.gz’
    R[write to console]: Installing package into ‘/usr/local/lib/R/site-library’
    (as ‘lib’ is unspecified)

    R[write to console]: Installing 34 packages: colorspace, viridisLite, RColorBrewer, munsell, labeling, farver, lattice, Matrix, nlme, withr, stringi, tidyselect, generics, proxy, scales, mgcv, MASS, isoband, gtable, cpp11, stringr, purrr, dplyr, Rcpp, cba, ggplot2, assertthat, dtw, emdist, tictoc, yaml, logging, tidyr, purrrlyr
    ...
    R[write to console]: Skipping install of 'itembankr' from a github remote, the SHA1 (1c9c3199) has not changed since last install.
      Use `force = TRUE` to force installation

    R[write to console]: Running `R CMD build`...

    * checking for file ‘/tmp/RtmpF0hCBk/remotes1e28721d0894/sebsilas-melsim-74a8b0d/DESCRIPTION’ ... OK
    * preparing ‘melsim’:
    * checking DESCRIPTION meta-information ... OK
    * checking for LF line-endings in source and make files and shell scripts
    * checking for empty or unneeded directories
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    2025-04-09 12:08:37.204667 INFO::Sliding on...
    2025-04-09 12:08:37.245159 INFO::Sliding on...
    2025-04-09 12:08:37.265385 INFO::Sliding on...
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    2025-04-09 12:08:37.324733 INFO::Sliding on...
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    2025-04-09 12:08:37.341383 INFO::Sliding on...
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 24.670 seconds)
