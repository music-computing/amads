...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    append_beat_tempo 1.6666666666666667 <amads.core.time_map.MapBeat object at 0x7f1921f8c9a0>
    ...
    BEGIN retie_note ['Note', 3.0016666666666665, 0.9983333333333333, None, 65, 'n3', True, <partitura.score.Note object at 0x7f1921f8e9e0>]
    GROUP BEFORE:  [['Note', 3.0016666666666665, 0.9983333333333333, None, 65, 'n3', True, <partitura.score.Note object at 0x7f1921f8e9e0>], ['Note', 4.0, 0.0016666666666666668, None, 65, 'n3a', True, <partitura.score.Note object at 0x7f1921f8d4e0>]]
    BEGIN retie_note ['Note', 4.0, 0, None, 65, 'n3a', True, <partitura.score.Note object at 0x7f1921f8d4e0>]
    BEGIN retie_note ['Note', 7.001666666666667, 0.9983333333333333, None, 71, 'n7', True, <partitura.score.Note object at 0x7f1921f8e020>]
    GROUP BEFORE:  [['Note', 7.001666666666667, 0.9983333333333333, None, 71, 'n7', True, <partitura.score.Note object at 0x7f1921f8e020>], ['Note', 8.0, 0.0016666666666666668, None, 71, 'n7a', True, <partitura.score.Note object at 0x7f1921f8c910>]]
    BEGIN retie_note ['Note', 8.0, 0, None, 71, 'n7a', True, <partitura.score.Note object at 0x7f1921f8c910>]
    BEGIN retie_note ['Note', 11.001666666666667, 0.9983333333333333, None, 71, 'n11', True, <partitura.score.Note object at 0x7f1921f8d060>]
    GROUP BEFORE:  [['Note', 11.001666666666667, 0.9983333333333333, None, 71, 'n11', True, <partitura.score.Note object at 0x7f1921f8d060>], ['Note', 12.0, 0.0016666666666666668, None, 71, 'n11a', True, <partitura.score.Note object at 0x7f1921f8ff40>]]
    BEGIN retie_note ['Note', 12.0, 0, None, 71, 'n11a', True, <partitura.score.Note object at 0x7f1921f8ff40>]
    BEGIN retie_note ['Note', 15.001666666666667, 0.9983333333333333, None, 67, 'n15', True, <partitura.score.Note object at 0x7f1921f8f5e0>]
    GROUP BEFORE:  [['Note', 15.001666666666667, 0.9983333333333333, None, 67, 'n15', True, <partitura.score.Note object at 0x7f1921f8f5e0>], ['Note', 16.0, 0.0016666666666666668, None, 67, 'n15a', True, <partitura.score.Note object at 0x7f1921f8cd30>]]
    BEGIN retie_note ['Note', 16.0, 0, None, 67, 'n15a', True, <partitura.score.Note object at 0x7f1921f8cd30>]
    Something is wrong; could not find measure for ['Note', 16.0, 0, None, 67, 'n15a', True, <partitura.score.Note object at 0x7f1921f8cd30>]
    partitura_convert_part: after pass 1, measures are
    [(1, 0, 2400), ('timesig', 4, 4), (2, 2400, 4800), (3, 4800, 7200), (4, 7200, 9600), (5, 9600, 9601)]
    div_to_quarter: div 2400 qtrs 4.0
    div_to_quarter: div 0 qtrs 0.0
    ...
    div_to_quarter: div 9600 qtrs 16.0
    ignoring 9600--9601 Measure number=5 name=5
    BEGIN retie_note ['Note', 2.0016666666666665, 1.9983333333333333, None, 43, 'n17', True, <partitura.score.Note object at 0x7f1921f8c850>]
    GROUP BEFORE:  [['Note', 2.0016666666666665, 1.9983333333333333, None, 43, 'n17', True, <partitura.score.Note object at 0x7f1921f8c850>], ['Note', 4.0, 0.0016666666666666668, None, 43, 'n17a', True, <partitura.score.Note object at 0x7f1921f8d690>]]
    BEGIN retie_note ['Note', 4.0, 0, None, 43, 'n17a', True, <partitura.score.Note object at 0x7f1921f8d690>]
    BEGIN retie_note ['Note', 6.001666666666667, 1.9983333333333333, None, 43, 'n19', True, <partitura.score.Note object at 0x7f1921f8e080>]
    GROUP BEFORE:  [['Note', 6.001666666666667, 1.9983333333333333, None, 43, 'n19', True, <partitura.score.Note object at 0x7f1921f8e080>], ['Note', 8.0, 0.0016666666666666668, None, 43, 'n19a', True, <partitura.score.Note object at 0x7f1921f8c670>]]
    BEGIN retie_note ['Note', 8.0, 0, None, 43, 'n19a', True, <partitura.score.Note object at 0x7f1921f8c670>]
    BEGIN retie_note ['Note', 10.001666666666667, 1.9983333333333333, None, 38, 'n21', True, <partitura.score.Note object at 0x7f1921f8f340>]
    GROUP BEFORE:  [['Note', 10.001666666666667, 1.9983333333333333, None, 38, 'n21', True, <partitura.score.Note object at 0x7f1921f8f340>], ['Note', 12.0, 0.0016666666666666668, None, 38, 'n21a', True, <partitura.score.Note object at 0x7f1921f8f310>]]
    BEGIN retie_note ['Note', 12.0, 0, None, 38, 'n21a', True, <partitura.score.Note object at 0x7f1921f8f310>]
    BEGIN retie_note ['Note', 14.001666666666667, 1.9983333333333333, None, 47, 'n23', True, <partitura.score.Note object at 0x7f1921f8f580>]
    GROUP BEFORE:  [['Note', 14.001666666666667, 1.9983333333333333, None, 47, 'n23', True, <partitura.score.Note object at 0x7f1921f8f580>], ['Note', 16.0, 0.0016666666666666668, None, 47, 'n23a', True, <partitura.score.Note object at 0x7f1921f8f820>]]
    BEGIN retie_note ['Note', 16.0, 0, None, 47, 'n23a', True, <partitura.score.Note object at 0x7f1921f8f820>]
    Something is wrong; could not find measure for ['Note', 16.0, 0, None, 47, 'n23a', True, <partitura.score.Note object at 0x7f1921f8f820>]
