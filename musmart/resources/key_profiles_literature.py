...
class _KeyProfile:
    ...
    major_sum: list[float] = field(default_factory=list)
    minor: list[float] = field(default_factory=list)
    minor_sum: list[float] = field(default_factory=list)
    ...
    def __getitem__(cls, key):
        ...
        # Slightly nicer error handling
            ...
            raise AttributeError(f"Key Profile '{cls.__repr__}' has no attribute '{key}'")
